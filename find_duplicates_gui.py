...
class DuplicateFinderApp:
    ...
    def _do_scan(self, folder):
        ...
        html.append(f'Created by Fred R Phillips for family and friends<br>')
        ...
        html.append(f'<div class="footer">Duplicate Photo Finder v{VERSION} &mdash; Created by Fred R Phillips for family and friends<br>')
